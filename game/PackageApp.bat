...
echo.
echo  [10] normal .AIR
echo  [11] bundle with included AIR runtime
echo  [12] .exe with included AIR runtime
echo.
...
if "%C%"=="10" set TARGET=air
if "%C%"=="11" set TARGET=bundle
if "%C%"=="12" set TARGET=exe

if %C% LSS 10 call bat\PackagerMobile.bat
if %C% GTR 9 call bat\PackagerDesktop.bat
